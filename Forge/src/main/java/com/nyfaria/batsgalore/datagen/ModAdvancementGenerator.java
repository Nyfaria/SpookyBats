...
public class ModAdvancementGenerator implements ForgeAdvancementProvider.AdvancementGenerator {
    ...
    public void generate(HolderLookup.Provider registries, Consumer<Advancement> saver, ExistingFileHelper existingFileHelper) {
        Advancement.Builder batsBuilder = Advancement.Builder.advancement()
                .display(ItemInit.WITCHES_BREW.get(), Component.translatable("advancements.batsgalore.bat_death"), Component.translatable("advancements.batsgalore.bat_death.desc"), new ResourceLocation("textures/gui/advancements/backgrounds/husbandry.png"), FrameType.TASK, true, true, false)
        ...
        Advancement.Builder.advancement()
                .parent(bats)
                .display(ItemInit.BAT_WINGS.get(), Component.translatable("advancements.batsgalore.massacre"), Component.translatable("advancements.batsgalore.massacre.desc"), new ResourceLocation("textures/gui/advancements/backgrounds/husbandry.png"), FrameType.CHALLENGE, true, true, true)
        ...
        Advancement.Builder builder = Advancement.Builder.advancement()
                ...
                .display(ItemInit.PUMPKIN_CHOCOLATE_BAR.get(), Component.translatable("advancements.batsgalore.candy_collection"), Component.translatable("advancements.batsgalore.candy_collection.desc"), new ResourceLocation("textures/gui/advancements/backgrounds/husbandry.png"), FrameType.CHALLENGE, true, true, false);
