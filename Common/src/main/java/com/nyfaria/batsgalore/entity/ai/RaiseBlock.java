 ...
 * </ul>
 */
public class RaiseBlock<E extends LivingEntity> extends ExtendedBehaviour<E> {
	 ...
	 * @return this
	 */
	public RaiseBlock<E> stopBreakingIf(TriPredicate<E, BlockPos, BlockState> predicate) {
	 ...
	 * @return this
	 */
	public RaiseBlock<E> forBlocks(TriPredicate<E, BlockPos, BlockState> predicate) {
	 ...
	 * @return this
	 */
	public RaiseBlock<E> timeToBreak(TriFunction<E, BlockPos, BlockState, Integer> function) {
