...
public class ShulkerBatRenderer extends SpookyBatRenderer<ModBat> {
	...
	public ShulkerBatRenderer(EntityRendererProvider.Context context, SpookyBatModel<ModBat> model) {
		super(context, model);
	}
