...
public class SlimeBatRenderer extends SpookyBatRenderer<ModBat> {
	public SlimeBatRenderer(EntityRendererProvider.Context p_173929_, SpookyBatModel<ModBat> model) {
