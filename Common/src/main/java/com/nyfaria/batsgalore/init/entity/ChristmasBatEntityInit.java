...
public class ChristmasBatEntityInit extends EntityInit {
    ...
    public static final RegistryObject<EntityType<ModBat>> REINDEER_BAT = registerEntityWithEgg("reindeer_bat", ()->EntityType.Builder.of(ModBat::new, MobCategory.MONSTER).sized(0.5F, 0.5F).clientTrackingRange(5),ModBat::createBatAttributes,16711680);
