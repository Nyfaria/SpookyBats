...
public record WoodCollection(String name, WoodType woodType, RegistryObject<SaplingBlock> sapling,
    ...
    public static WoodCollection registerCollection(String name) {
        ...
        RegistryObject<SaplingBlock> sapling = BlockInit.registerBlock(name + "_sapling", () -> new SaplingBlock(new SpookOakTreeGrower(), BlockBehaviour.Properties.copy(Blocks.OAK_SAPLING)));
