...
public class EntityInit {
    ...
    public static final RegistryObject<EntityType<SculkBat>> SCULK_BAT = registerEntityWithEgg("sculk_bat", () -> EntityType.Builder.of(SculkBat::new, MobCategory.MONSTER).sized(0.5F, 0.9F), SpookyBat::createBatAttributes, 0x0e151c, 0x009295);
    ...
    public static final RegistryObject<EntityType<SlimeBat>> SLIME_BAT = registerEntityWithEgg("slime_bat", () -> EntityType.Builder.of(SlimeBat::new, MobCategory.MONSTER).sized(0.5F, 0.9F), SpookyBat::createBatAttributes, 0x48a549);
